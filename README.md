...
- **104 built-in commands** across 5 tabs — Home, Insert, View, Table and Utilities — using Word terminology you already know.
- **Callouts of every flavor** — one **Callout** button opens a drop-down of Obsidian's twelve types: note, abstract, info, tip, success, question, warning, failure, danger, bug, example and quote.
...
96 of the 104 commands are registered in the command palette, so you can assign your own shortcuts. (Drop-down containers and the Emoji & Symbols panel are toolbar-only.)
