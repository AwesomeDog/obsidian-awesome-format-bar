...
| **Commandes**          | **154** intégrées, dont **140** dans la palette de commandes pour des raccourcis personnalisés |
...
### 🅰️ 154 commandes de mise en forme dans une disposition familière
...
140 des 154 commandes sont enregistrées dans la **palette de commandes**, vous pouvez donc leur attribuer vos propres raccourcis clavier.（Les conteneurs déroulants et le panneau Emoji et symboles n'existent que dans la barre d'outils.）
...
- **Paragraphe** —— Liste à puces / Liste numérotée / Liste de tâches, Citation, Diminuer / Augmenter le retrait, Renuméroter la liste, Trier les paragraphes, Monter / Descendre l’élément de liste, Monter / Descendre d'une ligne, Aligner à gauche / Centrer / Aligner à droite / Justifier, Ligne horizontale
...
5. Vous préférez le clavier ? Désactivez **les trois positions** et la barre disparaît entièrement de l'interface —— le plugin n'ajoute alors plus rien à votre écran, tandis que les **140 commandes enregistrées dans la palette** continuent de fonctionner et peuvent être associées à vos propres raccourcis dans **Paramètres → Raccourcis**. Autrement dit : vous pouvez l'utiliser comme un simple lot de commandes et de raccourcis, sans jamais cliquer sur un bouton.
